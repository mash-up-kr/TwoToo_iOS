...
| 챌린지 진행 상태 > 둘다 인증   | 챌린지 진행 상태가 둘다 인증 이다.             | 내 꽃의 인증 버튼 히든 여부가 true 로 표현된다. 상대방 꽃의 인증 완료 히든 여부가 false 로 표현된다. , 내 꽃의 칭찬 문구 히든 여부가 false 로 표현된다. 상대방 꽃의 칭찬 문구 히든 여부가 false 로 표현된다. , 하트 히든 여부가 false 로 표현된다. |
