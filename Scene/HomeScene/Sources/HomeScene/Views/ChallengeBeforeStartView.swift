...
protocol ChallengeBeforeStartViewDelegate: AnyObject {
...
final class ChallengeBeforeStartView: UIView {
    ...
    weak var delegate: ChallengeBeforeStartViewDelegate?
    ...
    lazy var confirmButton: TTPrimaryButtonType = {
        ...
        v.addAction { [weak self] in
            self?.delegate?.didTapChallengeBeforeStartConfirmButton()
        }
        return v
    }()
