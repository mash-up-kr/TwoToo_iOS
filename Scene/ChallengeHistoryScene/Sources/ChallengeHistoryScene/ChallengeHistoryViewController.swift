...
final class ChallengeHistoryViewController: UIViewController {
    ...
    lazy var gardenCollectionView: UICollectionView = {
        ...
        v.registerCell(ChallengeHistoryCardViewCell.self)
...
// MARK: - CollectionView
extension ChallengeHistoryViewController: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return 10
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueCell(type: ChallengeHistoryCardViewCell.self, indexPath: indexPath)
...
extension ChallengeHistoryViewController: UICollectionViewDelegate {
